...
describe('Game State Manager Tests', () => {
    ...
    describe('applyPlayerAction', () => {
        describe('bet action', () => {
            ...
            it('should apply opponent bet correctly', () => {
                const stateWithOpponentTurn = { ...initialGameState, currentPlayer: 'opponent' };
        ...
        describe('error handling', () => {
            ...
            it('should throw error for invalid action', () => {
                expect(() => {
                    gameManager.applyPlayerAction(initialGameState, 'invalid', true);
    ...
    describe('simulateGameScenario', () => {
        it('should simulate complete game: bet -> call -> showdown', () => {
            const actions = [
                { player: 'bet', isPlayer1: true },
                { player: 'call', isPlayer1: false }
            ];
        ...
        it('should simulate game: check -> check -> showdown', () => {
            const actions = [
                { player: 'check', isPlayer1: true },
                { player: 'check', isPlayer1: false }
            ];
            const results = gameManager.simulateGameScenario(initialGameState, actions);
        ...
        it('should handle errors in simulation', () => {
            const actions = [
                { player: 'bet', isPlayer1: false } // Wrong player turn
            ];
            const results = gameManager.simulateGameScenario(initialGameState, actions);
...
//# sourceMappingURL=gameStateManager.test.js.map